...
class ViewHolder extends RecyclerView.ViewHolder {
    ...
    // public ViewHolder loadUrl(@IdRes int viewId, String imageUrl) {
    //     ImageViewLoader
    //             .load(imageUrl)
...
//     public ViewHolder loadUrlRounded(@IdRes int viewId, @NonNull String imageUrl) {
//         ImageViewLoader
//                 .load(imageUrl)
//                 .circular()
//                 .into((ImageView) getView(viewId));

//         // TODO: This is a note about generating orb image. Make sure the bmp is ARGB_8888 format, or it will be fail.
// //            resource = resource.copy(Bitmap.Config.ARGB_8888, false);
// //            ImageView iv = getView();
// //            final int size = Math.min(iv.getWidth(), iv.getHeight());
// //            Bitmap mOrbBitmap = com.yahoo.mobile.client.android.ymagine.BitmapFactory.orbCreate(null, size);
// //            // native call to ymagine sdk - the below two calls are required to get the orb image effect
// //            com.yahoo.mobile.client.android.ymagine.BitmapFactory.orbRenderTile(mOrbBitmap, 1, 0, resource);
// //            com.yahoo.mobile.client.android.ymagine.BitmapFactory.orbRenderGrid(mOrbBitmap, 1, 0);
//         return this;
//     }

    /**
     * load drawable using image loading library.
     */
    // public void loadDrawable(@IdRes int viewId, @DrawableRes int drawableId) {
    //     ImageViewLoader.load(drawableId).into((ImageView) getView(viewId));
    // }
